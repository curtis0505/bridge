...
func NewTestClient(t *testing.T) clienttypes.ArbClient {
...
func TestClient_GetTransaction(t *testing.T) {
	b, err := NewTestClient(t).GetTransaction(context.Background(), "0x075516508ce1577e4f96b7360edbd388e39eaed1d8bda07b56a48970203023da")
	assert.NoError(t, err)
	assert.NotNil(t, b)
	t.Log(b.From())
}
...
func TestClient_GetTransactionReceipt(t *testing.T) {
	b, err := NewTestClient(t).GetTransactionReceipt(context.Background(), "0x075516508ce1577e4f96b7360edbd388e39eaed1d8bda07b56a48970203023da")
	assert.NoError(t, err)
	assert.NotNil(t, b)
	t.Log(b.Status())
}
